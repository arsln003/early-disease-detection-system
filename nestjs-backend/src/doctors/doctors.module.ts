...
@Module({
  imports: [TypeOrmModule.forFeature([Doctor,Assignment,AiResult,Feature,Report]), AuthModule, PredictionModule, CadicaModule, StrokeModule, ReportsModule], // register Doctor entity
